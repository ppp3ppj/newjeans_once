defmodule NewjeansOnceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NewjeansOnceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NewjeansOnceWeb.Gettext, "errors", msg, opts)
    end
  end
